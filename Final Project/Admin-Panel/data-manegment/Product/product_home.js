...
app.post('/product-edite', function(req, res) {
    ...
    // Extract form data
    const { id, productName, ProductCount, productType, ingredients, diseaseName, weight, companyName, age, single_price, box_price, discount, a_d_b_price, productDetails } = req.body;
    ...
    con.connect(function(err) {
        ...
        // Update query
        const sql = "UPDATE product_database SET productName=?, ProductCount=?, productType=?, ingredients=?, diseaseName=?, weight=?, companyName=?, age=?, single_price=?, box_price=?, discount=?, a_d_b_price=?, productDetails=? WHERE id=?";

        // Execute the query
        con.query(sql, [productName, productCount, productType, ingredients, diseaseName, weight, companyName, age, single_price, box_price, discount, a_d_b_price, publishedDate, productDetails, id], function(err, result) {
            if (err) {
